...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"widgetID"},
		@"ProjectId" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"projectID"},
		@"WidgetTypeId" : @{@"type": @"enumList", @"mappedType":@"NSNumber", @"mappedName": @"widgetTypeID"},
		@"Name" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"name"},
		@"Parameter" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"parameter"},
		@"SortOrder" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"sortOrder"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.widgetID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Widget/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Widget";
  
}

+ (instancetype)widgetWithID: (NSNumber *)objectID {
