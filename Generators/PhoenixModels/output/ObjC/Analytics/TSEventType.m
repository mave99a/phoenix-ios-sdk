...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"eventTypeID"},
		@"Name" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"name"},
		@"Description" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"eventTypeDescription"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.eventTypeID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/EventType/%@", [identifier stringValue]];
}
...
+ (instancetype)eventTypeWithID: (NSNumber *)objectID {
