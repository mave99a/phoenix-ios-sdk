...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"articleID"},
		@"Title" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"title"},
		@"Description" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"articleDescription"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.articleID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Article/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Article";
  
}

+ (instancetype)articleWithID: (NSNumber *)objectID {
