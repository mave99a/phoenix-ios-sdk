...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"aggregatorID"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.aggregatorID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Aggregator/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Aggregator";
  
}

+ (instancetype)aggregatorWithID: (NSNumber *)objectID {
