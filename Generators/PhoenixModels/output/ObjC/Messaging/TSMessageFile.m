...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"messageFileID"},
		...
		@"FileExtension" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"fileExtension"},
		@"MimeType" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"mimeType"},
		...
		@"Message" : @{@"type": @"relationship", @"mappedType":@"TSMessage", @"mappedName": @"message"}
	};
}

- (NSString *)dbKey {
	
    return [[self class] dbKeyWithID:self.messageFileID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/MessageFile/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/MessageFile";
  
}

+ (instancetype)messageFileWithID: (NSNumber *)objectID {
