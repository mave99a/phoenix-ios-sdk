...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"membershipID"},
		@"GroupId" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"groupID"},
		...
		@"JoinDate" : @{@"type": @"System.DateTime", @"mappedType":@"NSDate", @"mappedName": @"joinDate"},
		...
		@"Group" : @{@"type": @"relationship", @"mappedType":@"TSGroup", @"mappedName": @"group"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.membershipID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Membership/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Membership";
  
}

+ (instancetype)membershipWithID: (NSNumber *)objectID {
