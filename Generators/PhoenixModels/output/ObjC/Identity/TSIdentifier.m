...
#import "TSIdentifier.h"
#import "TSPhoenixClient.h"

@implementation TSIdentifier
...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"identifierID"},
		...
		@"IdentifierTypeId" : @{@"type": @"enumList", @"mappedType":@"NSNumber", @"mappedName": @"identifierTypeID"},
		@"IsConfirmed" : @{@"type": @"System.Boolean", @"mappedType":@"NSNumber", @"mappedName": @"isConfirmed"},
		@"Value" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"value"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.identifierID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Identifier/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Identifier";
  
}

+ (instancetype)identifierWithID: (NSNumber *)objectID {
