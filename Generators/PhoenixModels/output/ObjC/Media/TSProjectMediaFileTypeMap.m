//
//  TSPhoenix
//	TSProjectMediaFileTypeMap.m
//
//  Created by Steve on January 20th 2014.
//  Copyright (c) 2013 Tigerspike. All rights reserved.
//

#import "TSProjectMediaFileTypeMap.h"
#import "TSPhoenixClient.h"

@implementation TSProjectMediaFileTypeMap
...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"projectMediaFileTypeMapID"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.projectMediaFileTypeMapID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/ProjectMediaFileTypeMap/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/ProjectMediaFileTypeMap";
  
}

+ (instancetype)projectMediaFileTypeMapWithID: (NSNumber *)objectID {
