...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"channelID"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.channelID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Channel/%@", [identifier stringValue]];
}
...
+ (instancetype)channelWithID: (NSNumber *)objectID {
