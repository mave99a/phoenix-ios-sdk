...
#import "TSFileExtension.h"
#import "TSPhoenixClient.h"

@implementation TSFileExtension
...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"fileExtensionID"},
		@"MediaTypeId" : @{@"type": @"enumList", @"mappedType":@"NSNumber", @"mappedName": @"mediaTypeID"},
		@"Extension" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"extension"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.fileExtensionID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/FileExtension/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/FileExtension";
  
}

+ (instancetype)fileExtensionWithID: (NSNumber *)objectID {
