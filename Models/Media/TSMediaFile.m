...
#import "TSMediaFile.h"
#import "TSPhoenixClient.h"

@implementation TSMediaFile
...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"mediaFileID"},
		@"MediaId" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"mediaID"},
		@"ProcessedTypeId" : @{@"type": @"enumList", @"mappedType":@"NSNumber", @"mappedName": @"processedTypeID"},
		@"MediaFileTypeId" : @{@"type": @"System.Byte", @"mappedType":@"NSNumber", @"mappedName": @"mediaFileTypeID"},
		@"FilePath" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"filePath"},
		...
		@"MediaFileType" : @{@"type": @"relationship", @"mappedType":@"TSMediaFileType", @"mappedName": @"mediaFileType"}
	};
}

- (NSString *)dbKey {
	
    return [[self class] dbKeyWithID:self.mediaFileID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/MediaFile/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/MediaFile";
  
}

+ (instancetype)mediaFileWithID: (NSNumber *)objectID {
