...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"categoryID"},
		...
		@"Description" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"categoryDescription"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.categoryID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Category/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Category";
  
}

+ (instancetype)categoryWithID: (NSNumber *)objectID {
