...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"feedID"},
		@"SectionId" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"sectionID"},
		@"FeedTypeId" : @{@"type": @"enumList", @"mappedType":@"NSNumber", @"mappedName": @"feedTypeID"},
		...
		@"NextUpdate" : @{@"type": @"System.DateTime", @"mappedType":@"NSDate", @"mappedName": @"nextUpdate"},
		@"TTL" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"tTL"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.feedID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Feed/%@", [identifier stringValue]];
}
...
+ (instancetype)feedWithID: (NSNumber *)objectID {
