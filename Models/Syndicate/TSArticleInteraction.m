//
//  TSPhoenix
//	TSArticleInteraction.m
//
//  Created by Steve on January 23rd 2014.
//  Copyright (c) 2013 Tigerspike. All rights reserved.
//

#import "TSArticleInteraction.h"
#import "TSPhoenixClient.h"
#import "NSArray+Mapping.h"

@implementation TSArticleInteraction
...
+ (NSDictionary *)mappingDictionary {
	return @{
		...
		@"InteractionTypeId" : @{@"type": @"enumList", @"mappedType":@"NSNumber", @"mappedName": @"interactionTypeID"},
...
- (NSString *)dbKey {
		...
		return [NSString stringWithFormat:@"Phoenix/Article/%@/ArticleInteraction/%@", self.articleID, self.interactionTypeID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/ArticleInteraction/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/ArticleInteraction";
  
}

+ (instancetype)articleInteractionWithID: (NSNumber *)objectID {
