...
@implementation TSProjectAccountMap
...
+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/ProjectAccountMap/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/ProjectAccountMap";
  
}

+ (instancetype)projectAccountMapWithID: (NSNumber *)objectID {
