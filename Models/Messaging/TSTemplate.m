...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"templateID"},
		...
		@"PayloadUrl" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"payloadUrl"},
		...
		@"TemplateGroup" : @{@"type": @"relationship", @"mappedType":@"TSTemplateGroup", @"mappedName": @"templateGroup"}
	};
}

- (NSString *)dbKey {
	
    return [[self class] dbKeyWithID:self.templateID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Template/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Template";
  
}

+ (instancetype)templateWithID: (NSNumber *)objectID {
