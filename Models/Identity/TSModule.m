...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"enumList", @"mappedType":@"NSNumber", @"mappedName": @"moduleID"},
		...
		@"IsVisibleInPhoenix" : @{@"type": @"System.Boolean", @"mappedType":@"NSNumber", @"mappedName": @"isVisibleInPhoenix"},
...
+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Module/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Module";
  
}

+ (instancetype)moduleWithID: (NSNumber *)objectID {
