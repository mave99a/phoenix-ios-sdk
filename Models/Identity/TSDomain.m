...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"domainID"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.domainID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Domain/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Domain";
  
}

+ (instancetype)domainWithID: (NSNumber *)objectID {
