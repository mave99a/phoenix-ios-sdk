...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"projectID"},
		...
		@"StartDate" : @{@"type": @"System.DateTime", @"mappedType":@"NSDate", @"mappedName": @"startDate"},
		@"EndDate" : @{@"type": @"System.DateTime", @"mappedType":@"NSDate", @"mappedName": @"endDate"},
...
- (NSString *)dbKey {
    ...
    return [[self class] dbKeyWithID:self.projectID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Project/%@", [identifier stringValue]];
}
...
+ (instancetype)projectWithID: (NSNumber *)objectID {
