...
+ (NSDictionary *)mappingDictionary {
	return @{
		@"Id" : @{@"type": @"System.Int32", @"mappedType":@"NSNumber", @"mappedName": @"activityID"},
		@"ActivityGroupId" : @{@"type": @"System.Int16", @"mappedType":@"NSNumber", @"mappedName": @"activityGroupID"},
		@"Name" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"name"},
		@"Description" : @{@"type": @"System.String", @"mappedType":@"NSString", @"mappedName": @"activityDescription"},
		...
		@"ActivityGroup" : @{@"type": @"relationship", @"mappedType":@"TSActivityGroup", @"mappedName": @"activityGroup"}
	};
}

- (NSString *)dbKey {
	
    return [[self class] dbKeyWithID:self.activityID];
	
}

+ (NSString *)dbKeyWithID: (NSNumber *)identifier {
    return [NSString stringWithFormat:@"Phoenix/Activity/%@", [identifier stringValue]];
}
...
+ (NSString *)dbCollection {
  ...
  return @"Phoenix/Activity";
  
}

+ (instancetype)activityWithID: (NSNumber *)objectID {
